...
| PR-E24 | 两步化 batch 2 — 响应/技能面板 8 个候选点击改 select-then-confirm | 🟡 PR 待合并 |

总预估: **~2700-4000 LOC 变更**, 跨 24 个 review cycle。
...
- E25 (计划): guanxing / zhiheng / huogong / tiesuo modal 视觉升级卷轴风

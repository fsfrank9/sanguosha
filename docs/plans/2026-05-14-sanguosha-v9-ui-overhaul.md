...
| PR-E22 | 电脑回合节奏放慢 (enemyActionDelay 650→1300 + 拆 enemyPhaseDelay) | 🟡 PR 待合并 |

总预估: **~2700-3800 LOC 变更**, 跨 22 个 review cycle。
...
- E23 (计划): guanxing / zhiheng modal 升级卷轴风
- E24 (计划): huogong / tiesuo modal 升级卷轴风
- E25 (计划): PENDING_MODAL_DISPATCH 注册表补全 + card-as 流程一致性

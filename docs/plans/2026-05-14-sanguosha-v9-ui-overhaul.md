...
| PR-E23 | 二级面板两步化 (target/huogong 选中→确认) + 修 modal 误点手牌 bug | 🟡 PR 待合并 |

总预估: **~2700-3900 LOC 变更**, 跨 23 个 review cycle。
...
- E24 (计划): 两步化 batch 2 — 响应/技能面板 (guicai/fankui/fanjian/dyingRescue 等)
- E25 (计划): guanxing / zhiheng / huogong / tiesuo modal 升级卷轴风 (视觉)

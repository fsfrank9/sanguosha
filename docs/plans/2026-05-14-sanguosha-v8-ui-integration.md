...
| PR-D2 | pendingChoice auto 决策优化（cixiong-choose target / wugu-pick picker / guohe-1v1-pick source / guicai-replace holder 都改用 scoreCard 排序，替代原 deterministic hand[0] / pool[0] / equips[0]） | 🟡 PR 待合并 |
| _其余_ | _v8 方向 4 D3..D4 (1-ply lookahead / expectimax)_ | _按顺序推进_ |

...
| PR-D3 | 1-ply lookahead 框架：cloneGame + evaluateState + simulateCardPlay + scoreCardWithLookahead；aiChooseCard 改用启发 + 模拟 delta 综合分；致命牌优先级自动跃升 | 🟡 PR 待合并 |
| _其余_ | _v8 方向 4 D4 (expectimax 深度搜索)_ | _按顺序推进_ |

...
| PR-D1 | AI scoreCard 精细化 + estimateShaCount/estimateShanCount 辅助（武圣/龙胆/倾国/丈八 转化路径全部计入，桃 score 按 hp 缺口梯度，决斗/锦囊 按双方资源差给分） | 🟡 PR 待合并 |
| _其余_ | _v8 方向 4 D2..D4 (pendingChoice auto / 1-ply lookahead / expectimax)_ | _按顺序推进_ |

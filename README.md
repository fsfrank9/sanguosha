...
- **下一步 `v14`(规划)**:多目标杀架构(方天画戟/流离销账)→ 6-8 人大场 → AI 博弈深化(无懈 EV 补齐/内奸带门槛)→ 内容与模式决策门(蛊惑版本裁定/KOF 评估),见 [v14 路线图](docs/plans/2026-07-31-sanguosha-v14-roadmap.md)。
...
| v14(规划) | 多目标杀架构 + 6-8 人大场 + AI 博弈深化 + 工程清账 | `2026-07-31-…-v14-roadmap.md` |

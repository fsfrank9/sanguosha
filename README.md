...
- **当前推进 `v14`**:O 工程清账、P 多目标杀架构、Q AI 博弈深化、R 内容与模式决策门全部完成 — R-A 收尾批(暗身份推断提示徽章、4/5 人座席环压缩、死钮清理)与 R-B 蛊惑(风包现行版,虚拟声明牌层 + 质疑链 + 缠怨)已交付;KOF 经裁定不立项留占位,战报回放/移动端/国际化收案不做;6 人以上大场经用户裁定收案不做(5 人封顶)。见 [v14 路线图](docs/plans/2026-07-31-sanguosha-v14-roadmap.md)。

...
- **当前推进 `v14`**:O 工程清账、P 多目标杀架构、Q AI 博弈深化已完成(无懈 EV 全类建模、内奸装忠/拆家/终局收割 + 濒死救主带量化门禁、突袭真询问面板、铁骑次序对齐官方);R 决策门已裁定并推进中 — R-A 收尾批(暗身份推断提示徽章、4/5 人座席环压缩、死钮清理)已交付,R-B 蛊惑(风包现行版)独立立项推进;KOF 经裁定不立项留占位,战报回放/移动端/国际化收案不做;6 人以上大场经用户裁定收案不做(5 人封顶)。见 [v14 路线图](docs/plans/2026-07-31-sanguosha-v14-roadmap.md)。
...
| v14(后续) | R-B 蛊惑(风包现行版)独立立项 | `2026-07-31-…-v14-roadmap.md` |

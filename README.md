...
- **当前推进 `v14`**:O 工程清账、P 多目标杀架构已完成(方天画戟"最后手牌杀额外 +2 目标"与大乔流离转移真实现,杀链目标队列按官方座次环序逐席结算);后续 → Q AI 博弈深化(无懈 EV 补齐/内奸带门槛)→ R 内容与模式决策门(蛊惑版本裁定/KOF 评估);6 人以上大场经用户裁定收案不做(5 人封顶)。见 [v14 路线图](docs/plans/2026-07-31-sanguosha-v14-roadmap.md)。
...
| v14(后续) | AI 博弈深化 + 内容/模式决策门 | `2026-07-31-…-v14-roadmap.md` |

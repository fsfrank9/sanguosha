...
- **多模式**:1v1 对弈 + 3/4/5 人身份场(主/忠/反/内奸,座次环结算,内奸独立胜负)。
...
- **当前版本 `v13-K`**:4/5 人身份场与内奸胜负全量落地 + 结算加压自审修复 + audit backlog 三项销账;下一阶段(L 可选身份)见 [v13 路线图](docs/plans/2026-07-16-sanguosha-v13-roadmap.md)。

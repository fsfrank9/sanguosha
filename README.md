...
- **当前推进 `v14`**:O 工程清账、P 多目标杀架构、Q AI 博弈深化已完成(无懈 EV 全类建模、内奸装忠/拆家/终局收割 + 濒死救主带量化门禁、突袭真询问面板、铁骑次序对齐官方);仅余 → R 内容与模式决策门(蛊惑版本裁定/KOF 评估/UX 点单);6 人以上大场经用户裁定收案不做(5 人封顶)。见 [v14 路线图](docs/plans/2026-07-31-sanguosha-v14-roadmap.md)。
...
| v14(后续) | R 内容/模式决策门(蛊惑/KOF/UX 点单) | `2026-07-31-…-v14-roadmap.md` |

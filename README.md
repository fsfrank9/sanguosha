...
- **当前推进 `v14`**:O 工程清账已完成(测试 harness 统一 + 快/全分档 + 卫生清零 + 风包 gid 收案);后续 → 多目标杀架构(方天画戟/流离销账)→ AI 博弈深化(无懈 EV 补齐/内奸带门槛)→ 内容与模式决策门(蛊惑版本裁定/KOF 评估);6 人以上大场经用户裁定收案不做(5 人封顶)。见 [v14 路线图](docs/plans/2026-07-31-sanguosha-v14-roadmap.md)。
...
| v14(后续) | 多目标杀架构 + AI 博弈深化 + 内容/模式决策门 | `2026-07-31-…-v14-roadmap.md` |

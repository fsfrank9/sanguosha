...
- **内容**:71 名武将 / 54 个已接入技能 / 标准+军争核心 39 个牌型 142 张全可达,全部数据驱动;结算对照 `official-skill-cache/` 官方规则集,历经四轮全量合规审计;v14 R1 蛊惑(于吉,风包现行版)带质疑链与「缠怨」接入。
...
- **当前规划 `v15`**:主线 = 三扩展包内容接入(火 13 技 / 林 18 技 / 山 17 技 — 收官盘点证实 48 技逐字官方文本已全在本地 gltjk 镜像,纠正 v13 N3 "无 spec 源" 误判)+ 蛊惑收尾(响应窗口打出流程、声明菜单 16/16、AI 全型启发)+ 清账收官(散账显式裁决 + 第五轮全量审计);左慈化身设独立成本评估门。见 [v15 路线图](docs/plans/2026-08-04-sanguosha-v15-roadmap.md)。
...
- 多人专属技(激将/护驾/黄天/离间)随身份场(3/4/5 人)激活,1v1 中保持惰性;蛊惑(v14 R1,风包现行版)已接入 — 出牌阶段声明 + 全场质疑链 + 缠怨,1v1 与身份场均可用,响应窗口打出流程为已知局限(见 v14 路线图 R1 记录)。
...
| v15(规划) | 三扩展包接入(火/林/山 48 技)+ 蛊惑收尾 + 清账收官 | `2026-08-04-…-v15-roadmap.md` |

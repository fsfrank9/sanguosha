...
- **内容**:71 名武将 / 101 个已接入技能 / 标准+军争核心 39 个牌型 142 张全可达,全部数据驱动;结算对照 `official-skill-cache/` 官方规则集,历经四轮全量合规审计;蛊惑(于吉,风包现行版)带质疑链与「缠怨」,使用流程 16 型 + 响应窗口打出流程八窗口全接入(v14 R1 + v15 S)。
...
| v15-W(规划) | 清账收官 + 第五轮全量合规审计 | `2026-08-04-…-v15-roadmap.md` |

    ...
    var effectiveJudgementCard = deps.effectiveJudgementCard;
    var triggerGuidaoJudgementBeforeResolve = deps.triggerGuidaoJudgementBeforeResolve;
      ...
      function judge(game, actor, reason, opts) {
        ...
        var physicalCard = takeCard(game, null, { zone: 'deck' });
        if (!physicalCard) return null;
        var card = effectiveJudgementCard ? effectiveJudgementCard(game, actor, physicalCard) : physicalCard;
        ...
        if (triggerGuidaoJudgementBeforeResolve && judgementContext.card === card) {
          triggerGuidaoJudgementBeforeResolve(judgementContext);
        }

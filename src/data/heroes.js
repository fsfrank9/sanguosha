      ...
      var SKILL_METADATA = {
        ...
        huoshou:  { trigger: 'passive',            frequency: 'passiveAlways',   optional: false, mandatory: true,  cost: { type: 'none' },                     hooks: ['hasSkill'] },
        ...
        juxiang:  { trigger: 'passive',            frequency: 'passiveAlways',   optional: false, mandatory: true,  cost: { type: 'none' },                     hooks: ['hasSkill'] },
        ...
        wansha:   { trigger: 'passive',            frequency: 'passiveAlways',   optional: false, mandatory: true,  cost: { type: 'none' },                     hooks: ['hasSkill'] },
        luanwu:   { trigger: 'playPhase',          frequency: 'oncePerGame',     optional: true,  mandatory: false, cost: { type: 'none' },                     hooks: ['onActiveSkill'] },
        weimu:    { trigger: 'targetValidation',   frequency: 'passiveAlways',   optional: false, mandatory: true,  cost: { type: 'none' },                     hooks: ['hasSkill'] },
